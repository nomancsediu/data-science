...
1D array এর ইনডেক্সিং Python list এর মতোই, কিন্তু আরো ফিচার আছে:
...
2D array তে ইনডেক্সিং হলো `[row, column]`:
...
2D স্লাইসিং হলো `[row_start:row_stop, col_start:col_stop]`:
...
| 2D ইনডেক্সিং | রো, কলাম | `arr[0, 2]` |
| 2D স্লাইসিং | সাব-ম্যাট্রিক্স | `arr[:2, 1:3]` |
| বুলিয়ান | শর্ত দিয়ে ফিল্টার | `arr[arr > 30]` |
| ফ্যান্সি | নির্দিষ্ট ইনডেক্স | `arr[[0, 3, 5]]` |
| `.copy()` | নতুন মেমরি | `arr[1:4].copy()` |

ইনডেক্সিং আর স্লাইসিং হলো সেই জিনিস যেটা প্রায় প্রতিদিন ব্যবহার হয়। 2D স্লাইসিং এ গুলিয়ে যাওয়া সাধারণ, কোনটা রো, কোনটা কলাম। একটা সহজ নিয়ম মনে রাখতে হবে: প্রথমটা রো, দ্বিতীয়টা কলাম। `arr[রো, কলাম]`। আর বুলিয়ান ইনডেক্সিং হলো সবচেয়ে বেশি ব্যবহৃত, কারণ রিয়েল ডেটায় সবসময় শর্ত দিয়ে ফিল্টার করতে হয়।
